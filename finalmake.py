...
data1['video'] = data1['video'].astype(int)
data1['ROI'] = data1['ROI'].astype(int)
data1['finding'] = data1['finding'].astype(str)
data2['video'] = data2['video'].astype(int)
data2['ROI'] = data2['ROI'].astype(int)
data2['finding'] = data2['finding'].astype(str)

data1 = data1.set_index(['video', 'finding', 'ROI'])
data2 = data2.set_index(['video', 'finding', 'ROI'])

data = pd.merge(data1, data2, left_index=True, right_index=True)
data = data.drop(16091601)

data = data[[
    'timeseries',
    'timeseries_Gcorr_GS20',
    'timeseries_Gcorr_LD_GS20',
    'latency_raw',
    'TTP_Gcorr_LD_GS20',
    'IAP_Gcorr_LD_GS20',
    'drops_rel',
...
data['timeseries'] = ml.to_array(data['timeseries'].values, num=1490)
data['timeseries_Gcorr_GS20'] = ml.to_array(data['timeseries_Gcorr_GS20'].values, num=1490)
data['timeseries_Gcorr_LD_GS20'] = ml.to_array(data['timeseries_Gcorr_LD_GS20'].values, num=1490)
data['drops_rel'] = ml.to_array(data['drops_rel'].values)
data['drops_rel_med'] = ml.to_array(data['drops_rel_med'].values)

data = data.rename(columns={'timeseries':'NIR','timeseries_Gcorr_GS20':'NIR_Gcorr_GS20', 'timeseries_Gcorr_LD_GS20':'NIR_Gcorr_LD_GS20' })

#brez glajenja
data['NIR_255'] = data['NIR']/255
data['NIR_minmax'] = ml.get_minmax(data['NIR_255'])
data['NIR_diff'] = ml.get_gaussian_diff(data['NIR_255'])

#z gaussian glajenjem na 20
data['NIR_255_gs'] = ml.get_gaussian(data['NIR_255'].values, 20)
data['NIR_minmax_gs'] = ml.get_minmax(data['NIR_255_gs'])
